...
| `exporter.serviceMonitor.metricRelabelings` | Set metricRelabelings to be applied before ingestion                                                                                                                                       | `[]`                                                                                       |
| `exporter.serviceMonitor.relabelings`       | Set relabelings to be applied before scraping and ingestion                                                                                                                                | `[]`                                                                                       |
...
| `haproxy.metrics.serviceMonitor.metricRelabelings` | Set metricRelabelings to be applied before ingestion                                                                                                                                | `[]`                                                                                       |
| `haproxy.metrics.serviceMonitor.relabelings`       | Set relabelings to be applied before scraping and ingestion                                                                                                                         | `[]`                                                                                       |
