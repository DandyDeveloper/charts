...
| `containerSecurityContext`         | Security context to be added to the Redis containers.                                                                                                                                                   | `{ runAsNonRoot: true, allowPrivilegeEscalation: false, runAsUser: 1000, seccompProfile: { type: RuntimeDefault }, capabilities: {  drop: [ "ALL" ] }`                                     |
...
| `haproxy.containerSecurityContext`         | Security context to be added to the HAProxy containers.                                                                                                                                                   | `{ runAsNonRoot: true, allowPrivilegeEscalation: false, runAsUser: 1000, seccompProfile: { type: RuntimeDefault }, capabilities: {  drop: [ "ALL" ] }`                                     |
