...
| `exporter.serviceMonitor.disableAPICheck` | For to not check if api has "monitoring.coreos.com/v1"                                                                                                                                   | `false`                                                                                    |
...
| `haproxy.metrics.serviceMonitor.disableAPICheck`       | For to not check if api has "monitoring.coreos.com/v1"                                                                                                                                              | `false`                                                                                    |
