...
| `persistentVolume.volumeName`          | The name of the volume to be mounted                                                                                                                                                                               | data                                                                                       |
| `persistentVolume.existingClaim.name`          | The name of the existing Persistent volume claim  (PVC)                                                                                                                                                                              | example-pvc-name                                                                                       |
| `persistentVolume.existingClaim.claimSize`          | Amount of the existing Persistent volume claim (PVC) that will be used                                                                                                                                                                              | 10Gi                                                                                       |
