...
| `redis.securityContext.readOnlyRootFilesystem` | Requiring the use of a read only root file system                                                                                                                                   |`false`|
...
| `sentinel.securityContext.readOnlyRootFilesystem` | Requiring the use of a read only root file system                                                                                                                                |`false`|
...
| `exporter.securityContext.readOnlyRootFilesystem` | Requiring the use of a read only root file system                                                                                                                                |`false`|
...
| `splitBrainDetection.enableProbes`          | Enable or disable liveness and readiness probes                                                                                                                                      |`false`|
| `splitBrainDetection.securityContext.readOnlyRootFilesystem` | Requiring the use of a read only root file system                                                                                                                   |`false`|
