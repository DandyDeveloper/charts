...
| `ro_replicas`             | Comma separated list of slaves which never get promoted to be master. Count starts with 0. Allowed values 0-9. i.e. 3,4 - 3th and 4th redis slave never make it to be master, where master is index 0.   | ``                                                                                         |
