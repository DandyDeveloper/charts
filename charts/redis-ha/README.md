...
| `haproxy.image.rserviceAccountName`| HAProxy serviceAccountName                                                                                                                                                                                 | `default`                                                                                   |
...
| `haproxy.tls.keyName`        | Name of the key in the secret that contains the .pem file.                                                                                                                                                                           | `""`                                                                                        |
| `haproxy.tls.certMountPath`        | Path where to volume mount the secret that contains the .pem file.                                                                                                                                                                      | `""`                                                                                        |
